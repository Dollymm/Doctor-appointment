      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <ul className="flex gap-4 md:gap-7 font-bold md:flex-row md:mt-0">
            <li className="text-white mr-2 hover:text-blue-700 transition duration-300 mt-2 md:mt-1">
              For Doctors
            </li>
            <li class="text-indigo-700 mr-2 hover:text-blue-700 transition duration-300 border border-black rounded-full px-2 py-1 bg-white shadow-md hover:shadow-lg md:mr-0 md:mt-0
