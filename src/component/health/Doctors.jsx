...
const Doctors = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const doctorRes = await axios.get('https://doctor-backend-6.onrender.com/doctors');
  ...
  return (
    <div className="w-full md:w-3/5 mx-auto px-4 mb-4">
        ...
        <div key={id} className="bg-blue-900 rounded-lg shadow-md p-4 mb-4 text-white ">
          <div className="flex flex-wrap md:flex-nowrap items-center">
            <div className="md:w-1/4 md:mr-4 md:text-center mb-4 md:mb-0">
              <img src='' className="w-24 h-24 rounded-full mx-auto mb-4 md:mb-0" alt="Doctor Image" />
            ...
            <div className="md:w-3/4 ml-4">
              ...
              <div className="text-sm mb-2">{dr.experience}</div>
      ...
      <div className="flex justify-center">
        <button className="border border-indigo-800 hover:bg-blue-900 hover:text-white text-black rounded-lg px-2 py-2 font-semibold transition duration-300 w-48">View more</button>
      </div>
    </div>
  );
};
